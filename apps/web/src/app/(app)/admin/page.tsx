      ...
      <section className="soft-card p-6">
        ...
        <div className="mt-6 grid gap-3">
          {actions.map((action) => (
            <button
              key={action}
              className="flex items-center justify-between rounded-[1.4rem] border border-[var(--line)] bg-[var(--surface-soft)] px-4 py-4 text-left text-sm font-medium text-[var(--ink-700)]"
            >
              <span>{action}</span>
