  ...
  return (
    <div className="relative z-30 flex flex-col gap-4 rounded-[2rem] border border-white/80 bg-white/88 px-5 py-4 shadow-[0_18px_48px_rgba(127,139,176,0.12)] backdrop-blur-xl lg:flex-row lg:items-center lg:justify-between">
      <div className="relative flex items-center gap-4" ref={searchRef}>
        <form
          className="flex min-w-[min(100%,32rem)] items-center gap-3 rounded-full border border-[var(--line)] bg-[var(--surface-soft)] px-4 py-3 text-sm text-[var(--ink-500)]"
        ...
        {showSearchResults ? (
          <div className="absolute left-0 top-[calc(100%+0.75rem)] z-[70] w-full max-w-[32rem] rounded-[1.75rem] border border-white/90 bg-white/96 p-4 shadow-[0_24px_60px_rgba(127,139,176,0.18)] backdrop-blur-xl">
