...
export const demoPools: PoolRecord[] = [
  ...
  {
    id: "10",
    name: "Export Supplier Receivables Pool",
    category: "Trade Export",
    issuer: "Da Nang Supplier Group",
    originator: "FlowPay Originator VN",
    spv: "FlowPay SPV Kappa",
    debtor: "Asia Import Holdings",
    keyDebtorsLabel: "Asia Import Holdings, South Gate Trading",
    receivablesCount: 15,
    legalAssetHash:
    ...
    claimableAmount: 0,
    grossYieldPct: 5.74,
    annualizedYieldPct: 34.8,
    onTimeRepaymentRate: 95.9,
    lateExposurePercent: 2.7,
    durationDays: 44,
    riskGrade: "A",
    status: "Funding",
    fundedPct: 36,
    operatorName: "FlowPay Originator VN",
    servicerName: "FlowPay Trade Servicing VN",
    description:
      "A short-cycle export supplier invoice pool backed by repeat cross-border trade relationships.",
    strategy: "Short-duration supplier financing pool with moderate diversification across trade buyers.",
    assetType: "Export receivables",
    avgInvoiceSize: 987,
    avgMaturityDays: 44,
    dueLabel: "44 days",
    txSig: "7Pkz31...Flow10",
    nextDistributionLabel: "Expected after first export payer remittance",
    composition: {
      industryMix: [
        { label: "Export supply", percent: 52 },
        { label: "Trading", percent: 28 },
        { label: "Logistics support", percent: 20 },
      ],
      payerConcentration: [
        { label: "Top payer", percent: 22 },
        { label: "Second payer", percent: 15 },
      ],
      maturityBuckets: [
        { label: "0–30 days", percent: 19 },
        { label: "31–45 days", percent: 47 },
        { label: "46–60 days", percent: 34 },
      ],
    },
    repaymentEvents: [
      { date: "2026-05-16", type: "Pool opened", amount: 0, txSignature: "7Pkz31...Flow10" },
      { date: "2026-05-18", type: "Participation received", amount: 5328, txSignature: "7Pkz31...Fund10" },
    ],
    disclosures: [
      "Estimated yield is not guaranteed.",
      "Cross-border trade timing may affect payout schedules.",
    ],
  },
  {
    id: "11",
    name: "Retail Vendor Receivables Pool",
    category: "SME Retail",
    issuer: "Busan Retail Vendor Co.",
    originator: "FlowPay Originator KR",
    spv: "FlowPay SPV Lambda",
    debtor: "Urban Market Channels",
    keyDebtorsLabel: "Urban Market Channels, Seaside Consumer Stores",
    receivablesCount: 17,
    legalAssetHash:
    ...
    claimableAmount: 0,
    grossYieldPct: 5.12,
    annualizedYieldPct: 31.6,
    onTimeRepaymentRate: 96.8,
    lateExposurePercent: 1.9,
    durationDays: 41,
    riskGrade: "A",
    status: "Funding",
    fundedPct: 65,
    operatorName: "FlowPay Originator KR",
    servicerName: "FlowPay Retail Servicing KR",
    description:
      "A retail vendor invoice pool focused on repeat buyers and shorter replenishment cycles.",
    strategy: "Working-capital pool for smaller retail suppliers with strong repeat settlement behavior.",
    assetType: "Vendor receivables",
    avgInvoiceSize: 653,
    avgMaturityDays: 41,
    dueLabel: "41 days",
    txSig: "4Ltj81...Flow11",
    nextDistributionLabel: "Expected after retail settlement batch closes",
    composition: {
      industryMix: [
        { label: "Retail supply", percent: 56 },
        { label: "Consumer channels", percent: 24 },
        { label: "Vendor services", percent: 20 },
      ],
      payerConcentration: [
        { label: "Top payer", percent: 21 },
        { label: "Second payer", percent: 16 },
      ],
      maturityBuckets: [
        { label: "0–30 days", percent: 26 },
        { label: "31–45 days", percent: 51 },
        { label: "46–60 days", percent: 23 },
      ],
    },
    repaymentEvents: [
      { date: "2026-05-15", type: "Pool opened", amount: 0, txSignature: "4Ltj81...Flow11" },
      { date: "2026-05-18", type: "Participation received", amount: 7215, txSignature: "4Ltj81...Fund11" },
    ],
    disclosures: [
      "Estimated yield is not guaranteed.",
      "Retail payer concentration can still affect repayment timing.",
    ],
  },
  {
    id: "12",
    name: "Healthcare Services Receivables Pool",
    category: "Healthcare",
    issuer: "Metro Care Billing Services",
    originator: "FlowPay Originator PH",
    spv: "FlowPay SPV Mu",
    debtor: "City Health Systems",
    keyDebtorsLabel: "City Health Systems, Regional Clinic Alliance",
    receivablesCount: 21,
    legalAssetHash:
    ...
    claimableAmount: 0,
    grossYieldPct: 5.94,
    annualizedYieldPct: 39.2,
    onTimeRepaymentRate: 97.1,
    lateExposurePercent: 1.4,
    durationDays: 46,
    riskGrade: "A",
    status: "Funding",
    fundedPct: 53,
    ...
    servicerName: "FlowPay Healthcare Servicing",
    description:
      "A healthcare billing invoice pool supported by recurring institutional reimbursement flows.",
    strategy: "Defensive invoice investment pool built around short-duration healthcare receivables.",
    assetType: "Healthcare receivables",
    avgInvoiceSize: 833,
    avgMaturityDays: 46,
    dueLabel: "46 days",
    txSig: "8Qmd24...Flow12",
    nextDistributionLabel: "Expected after next healthcare payer settlement window",
    composition: {
      industryMix: [
        { label: "Healthcare billing", percent: 61 },
        { label: "Clinic operations", percent: 21 },
        { label: "Support services", percent: 18 },
      ],
      payerConcentration: [
        { label: "Top payer", percent: 19 },
        { label: "Second payer", percent: 14 },
      ],
      maturityBuckets: [
        { label: "0–30 days", percent: 18 },
        { label: "31–45 days", percent: 43 },
        { label: "46–60 days", percent: 39 },
      ],
    },
    repaymentEvents: [
      { date: "2026-05-17", type: "Pool opened", amount: 0, txSignature: "8Qmd24...Flow12" },
      { date: "2026-05-18", type: "Participation received", amount: 9275, txSignature: "8Qmd24...Fund12" },
    ],
    disclosures: [
      "Estimated yield is not guaranteed.",
      "Healthcare reimbursement timing can still shift cashflow timing.",
    ],
  },
];
